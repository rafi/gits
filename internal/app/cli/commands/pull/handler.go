// Package pull is the view side of `gits pull`: it resolves what to run on,
...
//   - project name
//   - repo
func ExecPull(format string, tags domain.TagSet, args []string, deps app.RuntimeCLI) error {
	...
	res := command.Command[pull.Report]{
		Name:     "pull",
		Verb:     "pulling",
		Do:       pull.Repo,
