...
func runtime(t *testing.T, workers int) service.Runtime {
	t.Helper()
...
func echo(delay func(string) time.Duration) func(
	context.Context, Repo, service.Runtime,
) (string, error) {
	return func(ctx context.Context, r Repo, _ service.Runtime) (string, error) {
		if delay != nil {
...
func TestRunProgressLifecycle(t *testing.T) {
	...
	cmd := Command[string]{
		Verb:     "testing",
		Progress: spy,
		Do: func(_ context.Context, r Repo, _ service.Runtime) (string, error) {
			switch r.GetName() {
			case "warn":
...
func TestRunCancellation(t *testing.T) {
	...
	cmd := Command[string]{
		Verb: "testing",
		Do: func(c context.Context, r Repo, _ service.Runtime) (string, error) {
			if started.Add(1) == 4 {
...
func TestRunKeepsBodyErrorsBare(t *testing.T) {
	...
	cmd := Command[string]{
		Verb: "testing",
		Do:   func(context.Context, Repo, service.Runtime) (string, error) { return "", boom },
	}
...
func TestRunCollectsTypedResults(t *testing.T) {
	...
	cmd := Command[*probe]{
		Verb: "testing",
		Do: func(_ context.Context, r Repo, _ service.Runtime) (*probe, error) {
