...
// TestBitbucketLoadReposCancelledCtx proves a pre-canceled context aborts
...
func TestBitbucketLoadReposCancelledCtx(t *testing.T) {
	...
	if err == nil {
		t.Fatal("LoadRepos with canceled ctx = nil error, want context.Canceled")
	}
...
// paginate() loop: a context canceled while page 1 is being served stops the
