// Package projects turns configured Projects into populated ones: it discovers
...
func Load(args []string, deps coreruntime.Runtime, opts ...Option) (domain.ProjectListKeyed, error) {
	var o options
...
func LoadOne(name string, deps coreruntime.Runtime, opts ...Option) (domain.Project, error) {
...
func populateProject(project *domain.Project, deps coreruntime.Runtime, o options) error {
